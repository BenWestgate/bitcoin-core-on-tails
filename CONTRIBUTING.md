Contributing to Bitcoin Core on Tails
============================

The Bitcoin Core on Tails project operates an open contributor model where anyone is
welcome to contribute towards development in the form of peer review, testing
and patches. This document explains the practical process and guidelines for
contributing.

First, in terms of structure, there is no particular concept of "Bitcoin Core on Tails
...
[good first issue](https://github.com/BenWestgate/bitcoin-core-on-tails/issues?q=is%3Aopen+is%3Aissue+label%3A%22good+first+issue%22)
list or changes that are
[up for grabs](https://github.com/BenWestgate/bitcoin-core-on-tails/issues?utf8=%E2%9C%93&q=label%3A%22Up+for+grabs%22).
...
For all issues and pull requests, the https://github.com/BenWestgate/bitcoin-core-on-tails node repository should be used.
...
[Translation Process](https://github.com/BenWestgate/bitcoin-core-on-tails/blob/master/doc/translation_process.md)
...
When a pull request conflicts with the target branch, you may be asked to rebase it on top of the current target branch.
    ...
    git fetch https://github.com/BenWestgate/bitcoin-core-on-tails  # Fetch the latest upstream commit
...
The following applies to code changes to the Bitcoin Core on Tails project (and related
wallet and seed backup projects).

Whether a pull request is merged into Bitcoin Core on Tails rests with the project merge
maintainers.
